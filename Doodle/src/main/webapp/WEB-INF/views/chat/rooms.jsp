		...
		success:function(result){
			...
			$.each(result,function(idx,chttRoomVO){
				...
				if(mberNm === chttRoomVO.crtrId){
					...
					str += "<img src='/resources/images/member/profile/user_l.png' class='profile-img' alt='친구1프로필사진'>";
					}else{
	...
	<div id="content">
		...
		<aside>
             <div class="main-menu" style="display: flex; justify-content: space-evenly;">
               <a href="/chat/friends?schulCode=${param.schulCode}">
                   <i class="fa-solid fa-user" alt="친구메뉴" title="친구"></i>
               </a>
               <a href="/chat/rooms?schulCode=${param.schulCode}&mberId=${USER_INFO.mberId}">
