...
$(function() {
	...
	$("#autoBtn").on("click",function(){
		...
		$("#pass").val("java");
		$("#ihidnum").val("990701-1735560");
		$("#moblphonNo").val("010-0248-9612");
		$("#mberEmail").val("teacheran@google.com");
		$("#zip").val("17962");
		$("#mberAdres1").val("경기 평택시 포승읍 하만호길 2");
		$("#mberAdres2").val("203번지");
		$("#cmmnEmpClsf").val("ROLE_A14002");
		$("#cmmnSchulPsitnSttus").val("A02104");
	});
	...
	$("#insertBtn").on("click",function(){
		...
		$.ajax({
			...
			success:function(result){
				if(result==2){
					resultSAlert(result,'교직원 등록을','교직원 목록으로 이동합니다.');
				}else{
					alertError('직원 등록에 실패하였습니다.', ' ');
				}
			}
		});
		}else {
      ...
      <form id="frm" action="" method="post" enctype="multipart/form-data">
         <ul class="signUpinputAll">
            <li>
               ...
               <input type="text" name="cmmnDetailCode" id="cmmnDetailCode" style="display:none;" value="ROLE_A01002" readonly>
            </li>
            <li>
               <span>직원 이름</span>
            ...
            <li>
				<span style="display:block;">직원 아이디</span>
            ...
            <li style="display: inline-block; margin-right: 70px;">
               <span>직원 구분</span>
               <select name="cmmnEmpClsf" id="cmmnEmpClsf">
					<option disabled selected>직원 구분을 선택하세요</option>
