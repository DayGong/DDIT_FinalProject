	...
	<form id="frm">
		<div class="dataRoomAll" style="width: 1400px; margin: auto; margin-bottom:50px;">
			...
			<div class="dataRoomTit">
				<input type="text"  class="form-control input-sm" style="width:95%;border:none;background: none;height: 50px;font-size: 1.4rem;display: inline-block;vertical-align: middle; margin-bottom:6px;"  name="nttNm" id="nttNm" value="${nttVO.nttNm}">
