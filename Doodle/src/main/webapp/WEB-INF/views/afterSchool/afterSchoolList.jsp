...
<div id="AfterSchoolContainer">
						...
						<div class="datatable-dashv1-list custom-datatable-overright">
							<div class="fixed-table-toolbar">
								<div class="pull-right search" style="margin-bottom: 20px;">
									<!-- 검색 셀렉트 -->
									<select class="form-control" id="cmmnAtnlcNm" class="searchCondition" style="transform: translate(-200px, 20px);">
			...
			<table id="table" class="table table-hover JColResizer" style="padding: 0 30px;">
				<thead>
					<tr style="font-size: 1rem;">
						<th style="width: 5%;" tabindex="0">
							<div class="th-inner ">번호</div>
							<div class="fht-cell"></div>
						</th>
						<th style="width: 20%;" tabindex="0">
							<div class="th-inner ">방과후학교명</div>
							<div class="fht-cell"></div>
						</th>
						<th style="width: 10%;" tabindex="0">
							<div class="th-inner ">수용정원(명)</div>
							<div class="fht-cell"></div>
						</th>
						<th style="width: 15%;" tabindex="0">
							<div class="th-inner ">수강시작일자</div>
							<div class="fht-cell"></div>
						</th>
						<th style="width: 15%;" tabindex="0">
	...
	<div>
		<div class="pagination text-center" style="width: 100%; transform: translate(350px, -20px);" id="divPaging"></div>
	</div>
</div>

<!-- 방과후학교 상세보기 모달 -->
<div id="afterSchoolDetail" class="modal modal-edu-general default-popup-PrimaryModal fade in" role="dialog" style="display: none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<h1 style="padding: 10px; font-size: 2.2em;">
					<img src="/resources/images/school/aftSchool/aftSchoolIcon4.png" style="width: 50px; display: inline-block; vertical-align: middel;">
			...
			<div class="modal-footer">
				...
				<c:if test="${USER_INFO.vwMemberAuthVOList[0].cmmnDetailCode == 'ROLE_A01003'}">
					<button type="button" id="btnRegist" class="btn btn-custon-rounded-four btn-primary">수강 신청</button>
				</c:if>
				<button type="button" id="btnRegist" class="btn btn-custon-rounded-four btn-primary" style="display:none;">수강 신청</button>
				<button type="button" id="btnCancle" class="btn btn-custon-rounded-four btn-default">닫기</button>
			</div>
		</div>
	</div>
</div>
