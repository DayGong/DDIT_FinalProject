				...
				<div class="class-container">
					<div class="courses-title">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
							...
							<!-- 방과후학교 생성 -->
							<div class="btn-zone">
								<button type="button" id="addAfterSchool" style="transform: translate(10px, -40px);">추가</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="courses-title">
						...
						<div style="padding: 0px; transform: translate(10px, -40px);">
							<ul class="nav nav-tabs custom-menu-wrap custon-tab-menu-style1 tab-menu-right">
								<li class="">
									<a data-toggle="tab" href="#TabStudList" aria-expanded="false">
										<span class="edu-icon edu-analytics tab-custon-ic"></span>학생 목록
									</a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#TabAttend" aria-expanded="false">
										<span class="edu-icon edu-analytics-arrow tab-custon-ic"></span>출석부
									</a>
								</li>
							</ul>
							<div class="tab-content">
								<div id="TabStudList" class="tab-pane flipInY custon-tab-style1 active">
									<div class="product-status-wrap drp-lst overflow-scroll" style="padding: 0px;">
...
<!-- 출석체크 모달 -->
<div id="AttendModalalert" class="modal modal-edu-general default-popup-PrimaryModal fade in" role="dialog" style="display: none; padding-right: 17px;">
