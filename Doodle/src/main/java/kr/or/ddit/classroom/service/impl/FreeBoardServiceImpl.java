...
public class FreeBoardServiceImpl implements FreeBoardService {
	...
	public int freeBoarRegistration(MemberVO memberVO, NttVO nttVO, List<MultipartFile> uploadList, ClasVO clasVO) {
		...
		log.debug("nttVO의 schulCode 학교코드 값 -> " + schulCode);
	...
	public int surveyCreateAjax(Map<String, Object> map) {
		...
		try {
			...
			voteNdQustnrVO.setVoteQustnrNm(String.valueOf(map.get("voteQustnrNm")));	// 설문지 이름 VO에 세팅
			voteNdQustnrVO.setVoteQustnrCn(String.valueOf(map.get("voteQustnrCn")));	// 설문지 목적 및 내용
			voteNdQustnrVO.setVoteQustnrBeginDt(format1);								//설문 시작 날짜 VO세팅
			voteNdQustnrVO.setVoteQustnrEndDt(format2);									//설문 종료 날짜 VO세팅
			voteNdQustnrVO.setCmmnDetailCode("A08003");									//설문 공통 코드 VO세팅
			voteNdQustnrVO.setVoteQustnrCode(String.valueOf(voteQustnrCode));			//설문 코드 VO세팅(시퀀스로관리)
			voteNdQustnrVO.setClasCode(map.get("clasCode").toString());					//설문 반코드 VO세팅
			voteNdQustnrVO.setSchulCode(map.get("schulCode").toString());				//설문 학교코드 VO세팅
			voteNdQustnrVO.setMberId(map.get("mberId").toString());						//설문 담임교사 VO세팅
			...
			for(Map<String, Object> tempMap : qustnrList) {
				VoteQustnrIemVO voteQustnrIemVO = new VoteQustnrIemVO();					//설문 항목 VO 생성(설문지 질문)
				voteQustnrIemVO.setVoteIemSn(++cnt);										//설문 항목 순번 (질문 번호) VO세팅
				voteQustnrIemVO.setVoteQustnrCode(String.valueOf(voteQustnrCode));			//설문 항목의 설문 코드 VO세팅
				voteQustnrIemVO.setVoteIemCn(String.valueOf(tempMap.get("voteIemCn")));		//설문의 항목 내용 (질문 내용) VO세팅
				...
				if(tempMap.get("voteDetailIemCn") != null) {
					...
					for(String str : voteDetailIemCnList) {
						...
						voteQustnrDetailIemVO.setVoteDetailIemSn(++detailCnt);						//설문 세부 항목 순번 VO세팅
						voteQustnrDetailIemVO.setVoteIemSn(cnt);									//설문 항목 순번 VO세팅
						voteQustnrDetailIemVO.setVoteQustnrCode(String.valueOf(voteQustnrCode));	//설문  코드 VO세팅
						voteQustnrDetailIemVO.setVoteDetailIemCn(str);								//설문 세부 항목 내용 VO 세팅
	...
	public int voteCreateAjax(Map<String, Object> map) {
		...
		try {
			...
			// VOTE_ND_QUSTNR INSERT
			voteNdQustnrVO.setVoteQustnrNm(String.valueOf(map.get("voteQustnrNm")));	// 투표 이름 VO에 세팅
			voteNdQustnrVO.setVoteQustnrCn(String.valueOf(map.get("voteQustnrCn")));	// 투표 목적 및 내용
			voteNdQustnrVO.setVoteQustnrBeginDt(format1);								// 투표 시작 날짜 VO세팅
			voteNdQustnrVO.setVoteQustnrEndDt(format2);									// 투표 종료 날짜 VO세팅
			voteNdQustnrVO.setCmmnDetailCode("A08004");									// 투표 공통 코드 VO세팅
			voteNdQustnrVO.setVoteQustnrCode(String.valueOf(voteQustnrCode));			// 투표 코드 VO세팅(시퀀스로관리)
			voteNdQustnrVO.setClasCode(map.get("clasCode").toString());					// 투표 반코드 VO세팅
			voteNdQustnrVO.setSchulCode(map.get("schulCode").toString());				// 투표 학교코드 VO세팅
			voteNdQustnrVO.setMberId(map.get("mberId").toString());						// 투표 담임교사 VO세팅
			...
			for(Map<String, Object> tempMap : qustnrList) {
				...
				voteQustnrIemVO.setVoteIemSn(++cnt);									// 투표 항목 순번 (투표 항목 번호) VO세팅
				voteQustnrIemVO.setVoteQustnrCode(String.valueOf(voteQustnrCode));		// 투표 항목 투표 코드 VO세팅
				voteQustnrIemVO.setVoteIemCn(String.valueOf(tempMap.get("voteIemCn")));	// 투표 항목 내용 (항목 내용) VO세팅
